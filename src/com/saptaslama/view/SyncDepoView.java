 ...
 * @author Shagy
 */
public class SyncDepoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        postDate.setBorder(BorderFactory.createLineBorder(
            Color.decode(RED)));
    ...
    syncDate.setBorder(BorderFactory.createLineBorder(
        Color.decode(RED)));
...
syncButton.addActionListener(new java.awt.event.ActionListener() {
    ...
    private Image loadImageIcon() {
        ...
        String location = "icons\\synchronize_24.png";
